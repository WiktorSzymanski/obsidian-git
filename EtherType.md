...
Lista wartości EtherType jest utrzymywana przez _Instytutem of Electrical and Electronica Engineers_ (_IEEE_). Dostępna jest pod adresem http://standards-oui.ieee.org/EtherType/eth.txt.
